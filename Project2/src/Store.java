...
public class Store {
    ...
    public static final Semaphore STORE_IS_OPEN_SEMAPHORE = new Semaphore(0, true); // Binary Semaphore that will block all customers from entering the store if it's closed.
