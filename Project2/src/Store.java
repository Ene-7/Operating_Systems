...
public class Store {
    ...
    public static final Semaphore STORE_CAPACITY_ENTRY = new Semaphore(Store_Capacity, true); // Counting Semaphore that will allow customer to enter in groups of size Store Capacity.
